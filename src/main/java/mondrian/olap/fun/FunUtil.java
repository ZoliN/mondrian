...
*/
    ...
    static TupleList nonEmptyOptimizeList(
            Evaluator evaluator,
            TupleList list,
            ResolvedFunCall call,
            int ctag)
    ...
    /**
     * This is the entry point to the crossjoin/drilldownmember etc. non-empty optimizer code.
     *
